...
class EmailDataModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        EmailData.objects.create(emails={'0': 'mail@gmail.com'}, subject='subject', message='message')
...
class EmailHistoryModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        email_data = EmailData.objects.create(emails={'0': 'mail@gmail.com'}, subject='subject', message='message')
